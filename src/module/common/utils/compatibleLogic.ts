...
export const ramIncompatible = (item: RAMType, selectedItems: SelectedItemType) => {
...
export const psuIncompatible = (item: PSUType, selectedItems: SelectedItemType) => {
  return psuPowerNotEnough(item.watt, getTotalPower(selectedItems))
}

export const caseIncompatible = (item: CaseType, selectedItems: SelectedItemType) => {
